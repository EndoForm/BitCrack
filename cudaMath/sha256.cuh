...
__constant__ unsigned int _IV[8] = {0x6a09e667, 0xbb67ae85, 0x3c6ef372,
...
__device__ __forceinline__ unsigned int MAJ(unsigned int a, unsigned int b,
                                            unsigned int c) {
  return (a & b) ^ (a & c) ^ (b & c);
}

__device__ __forceinline__ unsigned int CH(unsigned int e, unsigned int f,
                                           unsigned int g) {
  return (e & f) ^ (~e & g);
}
...
__device__ __forceinline__ void round(unsigned int a, unsigned int b,
                                      unsigned int c, unsigned int &d,
                                      unsigned e, unsigned int f,
                                      unsigned int g, unsigned int &h,
                                      unsigned int m, unsigned int k) {
  unsigned int s =
      CH(e, f, g) + (rotr(e, 6) ^ rotr(e, 11) ^ rotr(e, 25)) + k + m;
...
__device__ void sha256PublicKey(const unsigned int x[8],
...
__device__ void sha256PublicKeyCompressed(const unsigned int x[8],
